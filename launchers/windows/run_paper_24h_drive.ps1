...
$RunId = Resolve-TextSetting -Value $RunId -EnvName "PENNY_STOCK_PAPER_24H_RUN_ID" -DefaultValue ("paper_24h_" + (Get-Date -Format "yyyyMMdd_HHmmss"))
...
$RunRoot = Join-Path (Join-Path $DriveRoot "paper_24h_runs") $RunId
...
$LocalRunRoot = Join-Path (Join-Path $RootDir "data\paper_24h_runs") $RunId
...
Write-Host "========================================"
Write-Host " Penny Stock Radar Paper 24h Drive Run"
Write-Host "========================================"
Write-Host ""
Write-Host "Run id:"
Write-Host "  $RunId"
